...
for i = 1:nFile
    ...
    %slidePtr = openslide_open(['C:\BaiduNetdiskDownload\541544.svs']);
    mpp = imInfo.mppX(i);
...
%     thumnail = openslide_read_region(slidePtr,500, 500, 800, 800, 0);
...
% Close whole-slide image,6 note that the slidePtr must be removed manually
